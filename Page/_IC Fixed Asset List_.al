page 50008 "IC Fixed Asset List"
{
  ...
  var FBMDepBook: Record "FA Depreciation Book";
  ...
  MHFANo: Code[20];
  trigger OnAfterGetRecord()var FASetup: Record "FA Setup";
  begin
    //get depreciation details
    FASetup.Get();
    FBMDepBook.Reset();
    FBMDepBook.ChangeCompany(FASetup."FA Company");
  ...
  procedure InitTempTable()var FAFBM: Record "Fixed Asset";
  ...
  begin
    ...
    FAFBM.ChangeCompany(FASetup."FA Company");
 ...
 begin
      ...
      until(FAFBM.Next = 0)end;
  end;
  procedure GetSelectionFilter(): Text var FixedAsset: Record "Fixed Asset";
