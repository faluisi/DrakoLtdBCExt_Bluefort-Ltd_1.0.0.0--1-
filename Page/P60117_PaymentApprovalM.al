        ...
        repeat
            ...
            if compinfo.FBM_EnableAppr then begin
                ...
                repeat
                    ...
                    vlem.approved := vle.approved;
                    vle.CalcFields("Default Bank Account");
                    vlem."Default Bank Account" := vle."Default Bank Account";
                    vlem."approved date" := vle."approved date";
                    vlem."approved user" := vle."approved user";
                    vlem."Approver Comment" := vle."Approver Comment";
                    vlem.Insert();
            ...
            if vlem.FindFirst() then
                repeat
                    ...
                    if vle.FindFirst() then begin
                        ...
                        vle.approved := vlem.approved;
                        //vle."Default Bank Account" := vlem."Default Bank Account";
                        vle."approved date" := vlem."approved date";
                        vle."approved user" := vlem."approved user";
                        vle."Approver Comment" := vlem."Approver Comment";
                        vle.Modify();
                    end;
                until vlem.next = 0;
        until comp.next = 0;
