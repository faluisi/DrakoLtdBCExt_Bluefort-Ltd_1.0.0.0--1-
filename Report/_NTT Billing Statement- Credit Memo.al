report 50014 "NTT Billing Stat.-CreditMemo"
{
    DefaultLayout = RDLC;
    RDLCLayout = './RDLC/R50014 NTT Billing Statement CreditMemo.rdl';
    Caption = 'Billing Statement Credit Memo';
            ...
            "Integer")
            {
                ...
                "Integer")
                {
                    ...
                    "Sales Cr.Memo Line")
                    {
                        ...
                        column(Period_Start;
                        Format("Sales Cr.Memo Line"."Period Start", 0, '<Month Text,3> <Day>, <Year4>'))
                        {
                        }
                        column(Period_End;
                        Format("Sales Cr.Memo Line"."Period End", 0, '<Month Text,3> <Day>, <Year4>'))
                        {
                        }
    ...
    var
        Cnt: Record "Country/Region";
    begin
        if (SalesCrMemoHeader.Site <> '') then begin
            Site.SetFilter(Site."Site Code", SalesCrMemoHeader.Site);
