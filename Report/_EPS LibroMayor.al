report 50027 "Main Accounting Book"
{
    DefaultLayout = RDLC;
    RDLCLayout = './RDLC/R50027 MainAccountingBook.rdl';
    ...
    var
        Text1100002: Label 'Periodo: %1';
        Text1100003: Label 'Todos los importes son en  %1';
        Text1100005: Label 'No hay periodo entre este rango de fechas';
        ...
        Main_Accounting_BookCaptionLbl: Label 'Libro Mayor';
        CurrReport_PAGENOCaptionLbl: Label 'Página';
        Posting_DateCaptionLbl: Label 'Fecha Registro';
        DescriptionCaptionLbl: Label 'Descricción';
        DebitCaptionLbl: Label 'Débito';
        CreditCaptionLbl: Label 'Credito';
        Acum__Balance_at_dateCaptionLbl: Label 'Bal. Accum. a la Fecha';
        Net_ChangeCaptionLbl: Label 'Variacón neta';
        Continued____________________________CaptionLbl: Label 'Continua............................';
        Num_Account_CaptionLbl: Label 'Num.Cuenta:';
        Continued____________________________Caption_Control51Lbl: Label 'Continua............................';
        Num_Account_Caption_Control6Lbl: Label 'Num.Cuenta:';
        TotalCaptionLbl: Label 'Total';
        Total_Opening_EntriesCaptionLbl: Label 'Total Entradas Abertura';
        Total_Opening_EntriesCaption_Control31Lbl: Label 'Total Entradas Abertura';
        Total_Closing_EntriesCaptionLbl: Label 'Total Entradas Cierre';
        Text1100000Lbl: Label 'Encabezado';
        Total_Period_EntriesCaptionLbl: Label 'Total Entradas Periodo';
        Total_Period_EntriesCaption_Control50Lbl: Label 'Total Entradas Periodo';
        Total_Opening_EntriesCaption_Control108Lbl: Label 'Total Entradas Abertura';
        Total_Closing_EntriesCaption_Control109Lbl: Label 'Total Entradas Cierre';
        Total_Opening_EntriesCaption_Control68Lbl: Label 'Total Entradas Abertura';
        Total_Closing_EntriesCaption_Control70Lbl: Label 'Total Entradas Cierre';
        Total_Closing_EntriesCaption_Control91Lbl: Label 'Total Entradas Cierre';
