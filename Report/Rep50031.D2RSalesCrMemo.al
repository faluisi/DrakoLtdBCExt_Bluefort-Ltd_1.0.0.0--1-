        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            "Integer")
            {
                ...
                "Integer")
                {
                    ...
                    //BFT-001 -- begin
                    column(ContractCode;
                    "Sales Cr.Memo Header"."Contract Code")
                    {
                    }
                    column(RFCaption;
                    RFCCaption)
            ...
            begin
                if usersetup.get("Sales Cr.Memo Header"."User ID") then begin
                    FOR Index := 1 to usersetup."Signature PHL".COUNT DO BEGIN
                        ...
                        "Sales Cr.Memo Header".signature_pic.Insert(mediaid);
                        "Sales Cr.Memo Header".Modify();
                    end;
                end;
                FOR Index := 1 to "Sales Cr.Memo Header".signature_pic.COUNT DO BEGIN
                    IF TenantMedia.GET("Sales Cr.Memo Header".signature_pic.Item(1)) THEN BEGIN
