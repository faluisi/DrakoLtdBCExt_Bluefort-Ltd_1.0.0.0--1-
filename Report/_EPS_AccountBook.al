report 50035 "Account - Official Acc. Book"
{
    DefaultLayout = RDLC;
    RDLCLayout = './R50035_AccountOfficialAccBook.rdl';
    ...
    dataset
    {
        dataitem("Integer"; "Integer")
        {
            ...
            dataitem("G/L Entry Group"; "G/L Entry")
            {
                ...
                trigger OnAfterGetRecord()
                begin
                    if (GroupPostingDate = "Posting Date")  then
                        CurrReport.Skip();
                ...
                begin
                    ...
                    if AccPeriod.Next() = 0 then begin
                        if TableEnd then
                            ...
                            Error(StrSubstNo(Text1100005, "G/L Entry Group"."Transaction No."));
                    end else
