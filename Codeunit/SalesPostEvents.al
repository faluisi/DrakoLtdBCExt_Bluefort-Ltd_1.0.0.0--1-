codeunit 50003 SalesPostEvents
{
  ...
  var[EventSubscriber(ObjectType::Codeunit, Codeunit::"Sales-Post", 'OnBeforePostSalesDoc', '', true, true)]
  ...
  var GenJournalLine: Record "Gen. Journal Line")begin
  ...
  GenJournalLine: Record "Gen. Journal Line")begin
  ...
  GLEntry2: Record "G/L Entry")begin
  ...
  DtldCVLedgEntryBuffer: Record "Detailed CV Ledg. Entry Buffer")begin
