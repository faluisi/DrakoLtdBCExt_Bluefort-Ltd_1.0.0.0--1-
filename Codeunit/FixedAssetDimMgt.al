codeunit 50000 FixedAssetDimMgt
{
  trigger OnRun()begin
  end;
  procedure TrimDimName(RecordName: Text[2480])DimName: Text[50]var RecordNameLength: Integer;
  begin
  ...
  procedure AddDimensions(var Rec: Record Customer)var CompInfo: Record "Company Information";
  begin
    //Message('Here 1');
  ...
  local procedure AddCustDim(var Rec: Record Customer)var FASetup: Record "FA Setup";
  ...
  local procedure AddSameCustOperatorDim(var Rec: Record Customer)var FASetup: Record "FA Setup";
  ...
  procedure CreateSiteDim(CustSite: Record "Customer-Site")var DimValue_Site: Record "Dimension Value";
  FASetup: Record "FA Setup";
  ...
  procedure CreateCustOpSite(CustomerSite: Record "Customer-Site")var COS: Record "Cust-Op-Site";
  begin
    COS.Reset();
  ...
  procedure UpdateSiteDim(CustSite: Record "Customer-Site")var DimValue_Site: Record "Dimension Value";
  ParentChild: Record "Parent Child Relation";
  FASetup: Record "FA Setup";
  companyinfo: Record "Company Information";
  begin
  ...
  procedure RenameCustOpSite(xCustomerSite: Record "Customer-Site";
  CustomerSite: Record "Customer-Site")var COS: Record "Cust-Op-Site";
  begin
    COS.Reset();
  ...
  procedure RenameSiteDim(xCustSite: Record "Customer-Site";
  CustSite: Record "Customer-Site")var DimValue_Site: Record "Dimension Value";
  FASetup: Record "FA Setup";
  companyinfo: Record "Company Information";
  ...
  "Cust-Site": Record "Customer-Site")var FASetup: Record "FA Setup";
  ...
  procedure AssignFADimension()var FA: Record "Fixed Asset";
  ...
  Cust: Record Customer)var DimValCust: Record "Dimension Value";
  FASetup: Record "FA Setup";
  companyinfo: Record "Company Information";
  begin
    FASetup.Get();
  ...
  var DimValOp: Record "Dimension Value";
  FASetup: Record "FA Setup";
  companyinfo: Record "Company Information";
  begin
    FASetup.Get();
  ...
  //DEVOPS #619 -- begin
  procedure ContractDimension(Custsite: Record "Customer-Site")var ContractDim: Record "Dimension Value";
  FASetup: Record "FA Setup";
  CustOpSite: Record "Cust-Op-Site";
  begin
    if FASetup.Get()then begin
